import {
  ...
  import { ersGetAllReimbursements } from "../../../remote/ers/ers-functions";
  
  interface IAllReimbursementHistoryProps {
    updateCurrentUser: (u: User) => void;
    currentUser: User;
  }
  
  export const AllReimbursementHistory: React.FunctionComponent<IAllReimbursementHistoryProps> = (
    props
  ) => {
    ...
    useEffect(() => {
      const getReimbursements = async () => {
        let reimbs = await ersGetAllReimbursements();
        console.log(reimbs);
